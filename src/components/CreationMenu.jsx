...
const CreationMenu = ({ onRequestNew }) => {
  ...
  const menuItems = [
    ...
    {
      type: 'delivery_note',
      label: t('delivery_notes_page.new'),
      icon: ListOrdered,
    },
  ...
  return (
    // ZDE JE KLÍČOVÁ ZMĚNA: 'fixed' jsme změnili na 'absolute'
    <div className="absolute bottom-2 right-[-7.5rem] z-40">
      <div
      ...
      >
        ...
        <X
          className={`absolute transition-transform duration-300 ${
            isOpen ? 'rotate-0 scale-100' : '-rotate-45 scale-0'
          }`}
          size={32}
        />
      </button>
